...
const setCarrito = objeto =>{
    console.log(objeto)
    const producto= {
        id: objeto.querySelector('.btn-dark').data.id,
...
const pintarCarrito = () => {
    ...
    Object.values(carrito).forEach(producto => {
        ...
        templateCard.querySelectorAll('td')[1].textContent = producto.cantidad
    ...
    const pintarFooter = () => {
        ...
        if(Object.keys(carrito).length === 0) {
            footer.innerHTML =  `
            <th scope="row" colspan="5">Carrito vacío a comprar!</th>s 
            `
            return
